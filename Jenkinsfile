pipeline{
    ...
    stages{
        stage("Clone Repository"){
            ...
            steps{
                git branch: 'final', url: 'https://github.com/JaimeOjeda/project-devops.git'
                sh "echo Cloned!"
            }
        }
        stage("Prepare Docker image"){
            ...
            steps{
                ...
                sh "docker build -t jaime/final:v1 ."
                sh "docker save -o tienda.tar jaime/final:v1"
        ...
        stage("Deployment on QA environment"){
            ...
            steps{
                ...
                sh "docker run -idt -p 8081:80 --name tiendav1 jaime/final:v1 /bin/bash -c 'service mysql start; service apache2 start; mysql -h localhost --user='root' --password='123456' < db_sistema_mas_datos.sql; bash'"
            }
        }
